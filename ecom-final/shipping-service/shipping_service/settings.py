...
SECRET_KEY = config('SECRET_KEY', default='shipping-secret'); DEBUG = config('DEBUG', default=False, cast=bool)
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'shipping_service.urls'; WSGI_APPLICATION = 'shipping_service.wsgi.application'
