...
SECRET_KEY = config('SECRET_KEY', default='cart-secret'); DEBUG = config('DEBUG', default=False, cast=bool)
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'cart_service.urls'; WSGI_APPLICATION = 'cart_service.wsgi.application'
...
PRODUCT_SERVICE_URL = config('PRODUCT_SERVICE_URL', default='http://product-service:8001')
